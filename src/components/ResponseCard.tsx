...
export default function ResponseCard({
  ...
  return (
    <Card className={`w-full backdrop-blur-sm border-pink-300/30 dark:border-pink-800/30 shadow-neon hover:shadow-neon-lg transition-all duration-300 flex flex-col ${
